...
import { version, source_url, customVersion, customSourceUrl } from 'mastodon/initial_state';
    ...
    return (
      <div className='error-boundary'>
        <div>
          ...
          <p className='error-boundary__footer'>Mastodon v{version}{(customVersion || customSourceUrl) && <> · {customSourceUrl ? <a href={customSourceUrl} rel='noopener' target='_blank'>{customVersion ? `v${customVersion}` : customSourceUrl}</a> : `v${customVersion}`}</>} · <a href={source_url} rel='noopener' target='_blank'><FormattedMessage id='errors.unexpected_crash.report_issue' defaultMessage='Report issue' /></a> · <button onClick={this.handleCopyStackTrace} className={copied ? 'copied' : ''}><FormattedMessage id='errors.unexpected_crash.copy_stacktrace' defaultMessage='Copy stacktrace to clipboard' /></button></p>
        </div>
